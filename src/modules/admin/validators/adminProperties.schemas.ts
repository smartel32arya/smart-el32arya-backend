...
const url = z.string().url('يجب أن يكون رابطاً صالحاً')
...
export const createPropertySchema = z.object({
  ...
  bedrooms:     int('عدد غرف النوم يجب أن يكون رقماً صحيحاً').optional(),
  bathrooms:    int('عدد الحمامات يجب أن يكون رقماً صحيحاً').optional(),
  area:         pos('المساحة يجب أن تكون رقماً موجباً').optional(),
